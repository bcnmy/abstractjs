import { GLOBAL_CONSTANTS, RHINESTONE_ATTESTER_ADDRESS } from "@rhinestone/module-sdk"
import type { Hex } from "viem"
import { AddressConfig } from "../account/utils/getVersion"
export * from "./abi"
export * from "./tokens"
...
export const NEXUS_IMPLEMENTATION_ADDRESS: Hex =
  ...
  export const DEFAULT_CONFIGURATIONS_BY_NEXUS_VERSION: Record<string, AddressConfig> =
  {
    "1.0.2": {
